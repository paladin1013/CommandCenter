classdef ANC350 < Modules.Driver
    ...
    properties(SetObservable, GetObservable)
        ...
        multistep_ratio = Prefs.Integer(20, 'min', 0, 'max', 50, 'unit', '#', 'help', 'Do move steps `multistep_ratio` more times when `key_step`/`joy_step` is set to larger than 1.')
