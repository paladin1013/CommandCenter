classdef Line < Modules.Driver
    %Drivers.Attocube.Line is a wrapper for the knobs contained in an attocube axis
...
%                                             'help', 'Various operation modes available to each line. See manual for details.');
        ...
        step =      Prefs.Integer(0,    'min', -Drivers.Attocube.ANC300.maxSteps, 'max', Drivers.Attocube.ANC300.maxSteps, ...
                                            'set', 'set_step', 'display_only', true,    'unit', '#',...
        ...
        steps =     Prefs.Integer(Drivers.Attocube.ANC300.maxSteps, 'max', Drivers.Attocube.ANC300.maxSteps, 'unit', '#',...
        ...
        offset =    Prefs.Double(0,     'min', 0, 'max', 150, 'set', 'set_offset',      'unit', 'V',...
    ...
    properties(SetAccess=immutable, Hidden)
        parent; % Handle to Drivers.Attocube parent
    end
    ...
    methods(Static)
        function obj = instance(parent, line)
            ...
            persistent Objects
            if isempty(Objects)
                Objects = Drivers.Attocube.Line.empty(1,0);
            end
            ...
            obj = Drivers.Attocube.Line(parent, line);
            obj.singleton_id = id;
            Objects(end+1) = obj;
        end
    end
