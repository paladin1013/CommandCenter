...
%                                                                     'help_text', 'Crystal being used: 1,2,3. This also sets range');
        ...
        etalon_percent =    Prefs.Double(NaN,   'unit', '%',   'set', 'set_etalon_percent', 'min', 0, 'max', 100, 'default_step', 1, ...
        ...
        resonator_percent = Prefs.Double(NaN,   'unit', '%',   'set', 'set_resonator_percent', 'min', 0, 'max', 100, 'default_step', 1,...
