function obj = instance(varargin)
    ...
    persistent Objects
    if isempty(Objects)
        Objects = Experiments.PulseSequenceSweep.PolarizationAndReadoutEOM_tttr.empty(1,0);
    end
    ...
    obj = Experiments.PulseSequenceSweep.PolarizationAndReadoutEOM_tttr(varargin{:});
