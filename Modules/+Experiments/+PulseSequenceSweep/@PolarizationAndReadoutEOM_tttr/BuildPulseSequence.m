...
r_s1_begin_sync = node(r_s1,SyncChannel,'units','us', 'delta',-1.5);
...
r_s1_end_sync = node(r_e1,SyncChannel,'units','us', 'delta',0);
...
r_s2_begin_sync = node(r_s2,SyncChannel,'units','us', 'delta',0);
...
r_s2_end_sync = node(r_e2,SyncChannel,'units','us', 'delta',0);
