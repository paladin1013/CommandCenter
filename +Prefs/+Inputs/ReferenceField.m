        ...
        function [obj, height_px, label_width_px] = make_UI(obj, pref, parent, yloc_px, width_px, margin_px, readonly)
            ...
            if (isempty(obj.optimize) || ~isvalid(obj.optimize) || ~isprop(obj.optimize, 'UserData') || isempty(obj.optimize.UserData))
                ...
                elseif isprop(pref, "steponly") && pref.steponly
                    obj.optimize = uicontrol(parent,...
                                    'Style', 'togglebutton',...
                                    'String', char(0x26a0),...  % Gear icon 0x2699, tool icon 0x2692
                                    'FontSize', 11, ...
                                    'HorizontalAlignment','center',...
                                    'Units', 'pixels',...
                                    'Tag', tag,...
                    ...
                    obj.optimize = uicontrol(parent,...
                                    ...
                                    'Tag', tag,...
                                    'Enable', 'on',...
                                    'Tooltip', 'Optimize the target value. It will automatically release after finishing optimization, or user can click again to abort optimization.',...
